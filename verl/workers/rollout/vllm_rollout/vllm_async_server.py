...
class vLLMHttpServer:
    ...
    def __init__(
        ...
        usr_max_model_len = self.config.max_model_len
        print(f"[DEBUG] Rollout config model length {usr_max_model_len}")
        self.model_config: HFModelConfig = omega_conf_to_dataclass(model_config, dataclass_type=HFModelConfig)
        hf_max_model_len = get_max_position_embeddings(self.model_config.hf_config)
        print(f"[DEBUG] hf model length {hf_max_model_len}")
        self.config.max_model_len = min(hf_max_model_len,usr_max_model_len)
        print(f"[DEBUG] actual model length {self.config.max_model_len}")
